...
messaging.onBackgroundMessage(payload => {
  ...
  // Note: PWA/Web Push browsers do NOT support custom notification sound files.
  // Android/Chrome will use the browser/system notification sound.
  // We can add vibration pattern for Android devices that support it.
